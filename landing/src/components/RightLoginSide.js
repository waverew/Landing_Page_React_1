import "./RightLoginSide.css";
const RightLoginSide = () => {
  return (
    <div>
      ...
      <div className="ch7">
        <img
          src="./img/charts/rect/Rectangle.png"
          alt=""
          className="rect"
        ></img>
        <img
          src="./img/charts/rect/Rectangle-1.png"
          alt=""
          className="rect"
        ></img>
        <img
          src="./img/charts/rect/Rectangle-2.png"
          alt=""
          className="rect"
        ></img>
        <img
          src="./img/charts/rect/Rectangle-3.png"
          alt=""
          className="rect"
        ></img>
        <img
          src="./img/charts/rect/Rectangle-4.png"
          alt=""
          className="rect"
        ></img>
        <img
          src="./img/charts/rect/Rectangle-5.png"
          alt=""
          className="rect"
        ></img>
      </div>
